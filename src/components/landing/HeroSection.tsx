...
export function HeroSection() {
  return (
    <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden bg-background">
      ...
      >
        <div
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[hsl(var(--accent)_/_0.05)] to-[hsl(var(--primary)_/_0.05)] opacity-50 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="mt-16 flow-root sm:mt-24">
          <div className="relative rounded-xl bg-card/5 p-2 shadow-2xl ring-1 ring-inset ring-primary/10 lg:rounded-2xl lg:p-3 backdrop-blur-sm">
            ...
            >
              <div
                className="aspect-[1155/678] w-[60rem] bg-gradient-to-tr from-[hsl(var(--primary)_/_0.1)] to-[hsl(var(--accent)_/_0.1)] opacity-30 "
                style={{
                  clipPath:
