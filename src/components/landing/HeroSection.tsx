    ...
    <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
          Your Telegram, Automated and Enhanced by AI. <span className="block md:inline">Meet <span className="inline-block bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent tracking-normal leading-snug">TgTeleFlow</span>.</span>
        </h1>
